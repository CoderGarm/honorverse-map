export class SystemAssignmentHelperEra10 {
    ...
    static {
        ...
        SystemAssignmentHelperEra10.MONICA_SYSTEMS.push("Monica", "Taylor");
        SystemAssignmentHelperEra10.TORCH_SYSTEMS.push();
        SystemAssignmentHelperEra10.PHOENIX_SYSTEMS.push("Terra Haute", "Hennesy");

        SystemAssignmentHelperEra10.MANTICOREAN_SYSTEMS.push(
            ...
            "Chelsea", "Mendoza", "Clairmont", "Talbot", "Treadway", "Micah", "Danfeng", "Liberty", "Sallah", "Adler", "Vishnu", "Rasalas", "Solway",
            "Madras", "Corrigan", "Vortexia", "Sun-Yat", "Paragon", "Samson", "Runciman", "Franconia", "Hyacinth", "Lowell", "Thetis", "Nightingale",
            "Welladay", "Hamal", "Seabring", "Asad", "Trevor's Star", "Owens", "Tahlman"
        );

        SystemAssignmentHelperEra10.HAVENITE_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra10.MALIGN_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra10.SILESIA_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra10.ANDERMANI_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra10.SOLARIAN_SYSTEMS.push(
