...
export class SystemAssignmentEra1 extends MapContainer {
    ...
    constructor() {
        ...
        this.HAVENITE_SYSTEMS.push(
            ...
            "Seabring", "Garnet Star", "Poe", "Malagasy", "Stocum", "Asad", "Flegetonte", "Montague", "Daggan", "MacGregor", "Vishnu",
            "Nanda", "Sarawak", "Tequila", "Ueshiba", "J-156-18(L)", "Atakoraka", "Ebla", "Hadar", "Dorcas", "Ralko", "Rasalas", "Sallah", "Liberty", "Danfeng"
        );
