export class SystemAssignmentHelperEra8 {
    ...
    static {
        ...
        SystemAssignmentHelperEra8.MONICA_SYSTEMS.push("Monica", "Taylor");
        SystemAssignmentHelperEra8.TORCH_SYSTEMS.push();
        SystemAssignmentHelperEra8.PHOENIX_SYSTEMS.push("Terra Haute", "Hennesy");

        SystemAssignmentHelperEra8.MANTICOREAN_SYSTEMS.push(
            ...
            "Seaford 9", "Chelsea", "Mendoza", "Clairmont", "Talbot", "Treadway", "Micah", "Danfeng", "Liberty", "Sallah", "Adler", "Vishnu", "Rasalas", "Solway",
            "Madras", "Corrigan", "Vortexia", "Sun-Yat", "Paragon", "Samson", "Runciman", "Franconia", "Hyacinth", "Lowell", "Thetis", "Nightingale",
            "Welladay", "Hamal", "Tahlman", "Asad", "Seabring",
        );

        SystemAssignmentHelperEra8.HAVENITE_SYSTEMS.push(
            "Suarez", "Danak", "Santander", "Joust", "Alto Verde", "Michael",
            "Shilo", "Fordyce", "Lorn", "Pegasus", "Prague", "Mylar", "Montague",
            "Chantilly", "Solan", "Augusta", "Jameston", "Rutgers", "Hallman",
            "Paroa", "Tequila", "Secour", "Barnett", "Sullah", "Karavani",
            "La-Martine", "Des-Moines", "Solon", "SXR-136-23", "Clarke", "Lovat",
            "Lowell", "Mathias", "Sheldon", "Owens", "Tarragon", "Gualt",
            "Gaston", "Tambourin", "Squalus", "Helmsport", "Seljuk", "Laramie", "Haven",
            "Jouett", "Refuge", "Morell", "New Calcutta", "Malagasy", "Hera (Haven-Sector)",
            "Lannes", "MacGregor", "Maslow", "Trevor's Star", "Maastricht",

            "Barnes", "Cerberus", "Slocum (Haven-Sector)",
            ...
            "Markab", "Mathias", "Mendel", "Merope", "Mesarthim", "Michael", "Mylar", "Nebulae",
            "Nikawiy", "Owens", "Paragon", "Pollux", "Ran", "Revati", "Spectre", "Secour",
            ...
            "Seabring", "Garnet Star", "Poe", "Malagasy", "Stocum", "Flegetonte", "Montague", "Daggan", "MacGregor",
            "Nanda", "Sarawak", "SXR-136-23", "Tequila", "Ueshiba", "J-156-18(L)"
        );

        SystemAssignmentHelperEra8.MALIGN_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra8.SILESIA_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra8.ANDERMANI_SYSTEMS.push(
        ...
        SystemAssignmentHelperEra8.SOLARIAN_SYSTEMS.push(
